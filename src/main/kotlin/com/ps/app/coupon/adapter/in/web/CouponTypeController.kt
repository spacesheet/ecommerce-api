package com.ps.app.coupon.adapter.`in`.web

import com.ps.app.coupon.adapter.`in`.web.dto.CouponTypeResponse
import com.ps.app.coupon.adapter.`in`.web.dto.CreateCouponTypeRequest
import com.ps.app.coupon.application.port.`in`.*
import com.ps.app.coupon.application.usecases.CreateCouponTypeUseCase
import com.ps.app.coupon.application.usecases.GetCouponTypeUseCase
